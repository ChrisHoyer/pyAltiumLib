...
# ============================================================================= 
    ...
    def draw_svg(self, dwg, offset, zoom):
        ...
        # Draw hole
        if self.hole_size > 0:
            self.draw_svg_hole(dwg, offset, zoom, 81)
    ...
    def draw_svg_hole(self, dwg, offset, zoom, layer_id):
        ...
        path = self.get_rounded_rect_path(start, size, layer_id, corner_radius)
    ...
    def draw_svg_pad_element(self, dwg, offset, zoom, size, shape, plot_layer, ref_layer=None):
        ...
        if shape.to_int() == 1: 
            ...
            path = self.get_rounded_rect_path(start, size, plot_layer,
